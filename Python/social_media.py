...
| 03/13 at 11:51 pm
Grading comment:
-2: You already have functions common_friends and friends_of_friends that handles this computation.  You should reuse it; rewriting the same logic in multiple places makes code that is hard to read, hard to maintain, and hard to debug.
...
| 03/13 at 11:51 pm
Grading comment:
-1: Calling number_of_common_friends_map calculates extra information that you don't need in this function. Notice that all you need is the set of keys of that map, which are basically the return of friends_of_friends.
...
| 03/13 at 11:53 pm
Grading comment:
-1: Make sure to call .close() on files that you open to conserve resources.
